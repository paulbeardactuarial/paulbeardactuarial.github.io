...
-   I am a technically strong Fellow of the Institute of Actuaries working in the life insurance industry for `r {floor(interval(ISOdate(2012,9,3), now()) / years(1))}` years, with `r {floor(interval(ISOdate(2017,12,1), now()) / years(1))}` years post qualification.
...
<div class="major-section-break"></div>
...
<strong>Choose Your Adventure. What Work Experience Are You Interested In?</strong>
...
::: {.content-section data-tags="Commercial Real Estate Loans, R, Internal Model"}
...
::: {.content-section data-tags="Longevity, Internal Model"}
...
::: {.content-section data-tags="Longevity, With Profits Management, Mentor"}
