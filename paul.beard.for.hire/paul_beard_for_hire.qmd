...
-   [Keenu.io](https://keenu.io/) is an A.I. Tech Start-up, which aims to create a simulated version of the IELTS (International English Language Testing System) speaking exam. I collaborated with the small team of founders to develop A.I. solutions.
...
-   One of the big challenges is getting an accurate score for the various facets of the speaking exam, based on the speech submitted by a student. To do this I have worked in Python, doing the following:
    -   Interacted with the APIs (Application Programming Interface) or SDKs (Software Development Kit) of various LLMs (Large Language Model) available.
...
-   As well as being able to develop complex actuarial models, the project entailed the following:
    ...
    -   Developing a complete package of functions, data and tests that was rolled out to other actuaries
...
I write articles applying actuarial techniques and exploring topics in the industry. Some highlights include:
...
There is currently an interactive dashboard connected to this model which can be explored [here](https://paulbeardactuarial.shinyapps.io/cmi_dashboard/). A password is required for access, however it can be disclosed upon request (get in touch on LinkedIn)
